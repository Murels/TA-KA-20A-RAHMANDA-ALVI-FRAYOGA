        ...
        <section id="section_frame" class="w-1/3 border-2 border-rose-500 rounded-xl p-5 bg-indigo-100">
            ...
            <section id="section_input" class="flex flex-col">
                ...
                <input type="text" name="txt_username" id="txt_username"
                    class="h-10 border-solid border-2 border-cyan-700 rounded-xl focus:outline-none focus:ring focus:border-blue-500 mb-2.5 p-2.5"
                    placeholder="Isi Username" onkeypress="return setFilterInput(event)"
                ...
                <input type="password" name="txt_password" id="txt_password"
                    ...
                    onkeypress="return setFilterInput(event)"
                    onpaste="return false"
                    oncut="return false"
                    oncopy="return false">>
